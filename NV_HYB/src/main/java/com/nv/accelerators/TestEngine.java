...
import com.nv.support.ConfiguratorSupport;
import com.nv.support.HtmlReportSupport;
import com.nv.support.MyListener;
import com.nv.support.ReportStampSupport;
import com.nv.util.SendMail;
...
public class TestEngine extends SendMail {
	...
	public  String URL= configProps.getProperty("EDTC_URL");
	...
	public void first(ITestContext ctx,String browser) throws Throwable{
		...
		if(browser.equalsIgnoreCase("firefox")){
			extent=new ExtentReports(System.getProperty("user.dir")+"\\Reports\\Firefox\\"+browser+"ExecutionResults.html",false);	
		}else if(browser.equalsIgnoreCase("Chrome")){
			extent=new ExtentReports(System.getProperty("user.dir")+"\\Reports\\Chrome\\"+browser+"ExecutionResults.html",false);
		}else if(browser.equalsIgnoreCase("ie")){
			extent=new ExtentReports(System.getProperty("user.dir")+"\\Reports\\IE\\"+browser+"ExecutionResults.html",false);
		}else if(browser.equalsIgnoreCase("Safari")){
			extent=new ExtentReports(System.getProperty("user.dir")+"\\Reports\\Safari\\"+browser+"ExecutionResults.html",false);
		}
...
//			FileUtils.deleteDirectory(new File(System.getProperty("user.dir")+"\\Reports\\Screenshots")); // Delete ScreenShots folder
	...
	public void reportHeader(Method method, ITestContext ctx,String ip,String appURL) throws Throwable {
		itc = ctx;
		...
		if(browsertype.equalsIgnoreCase("firefox"))
			...
			webDriver=new RemoteWebDriver(new  URL(ip), dr);
			...
			if(browsertype.equalsIgnoreCase("firefox"))
			{
				System.setProperty("webdriver.firefox.bin","C:\\Users\\IN01612\\AppData\\Local\\Mozilla Firefox\\firefox.exe");
