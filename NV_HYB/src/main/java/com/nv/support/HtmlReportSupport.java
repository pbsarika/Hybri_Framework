...
import com.nv.accelerators.TestEngine;
...
public class HtmlReportSupport {
	...
	public static void createHtmlSummaryReport(String browser,
		...
		try {
			...
			writer.write("<img align ='left' src= ./Screenshots/cigniti.png></img>");
			writer.write("</th>");
			writer.write("</tr> ");
			...
			writer.write("National Vision -  Automation Execution Result Summary ");
			writer.write("</th> ");
			writer.write("</tr> ");
